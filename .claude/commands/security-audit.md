---
description: Run all 7 active security audits against a running HWP site and save a consolidated report to docs/audits/{slug}/security-audit-{date}.md. Use before any production deployment, after adding user-input blocks, or when setting up a new client site.
