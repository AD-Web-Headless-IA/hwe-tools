...
3. Copy the template from `hwp-tools/.claude/templates/design-language.md` (or `.hwp-tools/.claude/templates/design-language.md` when running from a client repo).
