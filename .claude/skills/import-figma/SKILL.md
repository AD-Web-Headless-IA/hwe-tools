...
From the sub-agent's JSON, generate `hwe-platform/docs/clients/{slug}/figma-analysis.md`:
...
3. Copy the template from `hwe-tools/.claude/templates/design-language.md` (or `.hwe-tools/.claude/templates/design-language.md` when running from a client repo).
